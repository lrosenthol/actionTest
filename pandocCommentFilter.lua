...
Copyright (C) 2020, Adobe (via Leonard Rosenthol)
...
lrosenth: Added support for the `toc` class for adding a TOC in Word where I want it
...
LATEX_TEXT.block_toc = {}
LATEX_TEXT.block_toc.Open = latex('\\toc')
LATEX_TEXT.block_toc.Close = {}
LATEX_TEXT.comment = {}
...
HTML_TEXT.block_toc = {}
HTML_TEXT.block_toc.Open = html('<div style="text-align:center";>')
HTML_TEXT.block_toc.Close = html('</div>')
HTML_TEXT.comment = {}
...
local COMMENT_FILTER = {
    ...
    {RawBlock = RawBlock, Para = Para},  -- Handle forced page breaks
